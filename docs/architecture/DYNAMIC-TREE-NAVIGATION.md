...
The normative interaction, overflow, theme, and localization rules are in the design-system [Tree navigation standard](../design-system/TREE-NAVIGATION.md).
...
Shared row interaction follows the [Tree navigation standard](../design-system/TREE-NAVIGATION.md); `TreeRowVisualStateResolver` is its framework-neutral state boundary.
