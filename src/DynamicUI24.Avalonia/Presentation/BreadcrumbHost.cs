...
public sealed class BreadcrumbHost : StackPanel
{
    ...
    private void Rebuild()
    {
        ...
        {
            if (index > 0) Children.Add(new TextBlock { Text = ">", VerticalAlignment = VerticalAlignment.Center });
            ...
            if (crumb.IsCurrent) Children.Add(new TextBlock { Text = Localize(crumb.DisplayNameKey), FontWeight = global::Avalonia.Media.FontWeight.SemiBold,
