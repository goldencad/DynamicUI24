...
public static class SetupActionBarDefinitions
{
    private static ActionDefinition Command(string code, string key, IconKey icon, int order,
        ...
        IEnumerable<ActionMenuItemDefinition>? menuItems = null, bool isChecked = false) => new(code, code, new(key), icon,
    ...
    [
        ...
        Command(SetupActionCodes.Validate, "Setup.Action.Validate", StandardIconKeys.Validate, 30, new("SETUP.VALIDATE"), true,
            ActionButtonVariant.IconButton),
    ...
    [
        ...
        Command(SetupActionCodes.ToggleDetails, "Setup.Action.ToggleDetails", StandardIconKeys.Preview, 30,
            variant: ActionButtonVariant.ToggleButton),
    ]);
}
